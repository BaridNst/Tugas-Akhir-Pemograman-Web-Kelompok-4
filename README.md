...
* **📊 Dashboard Monitoring**: Visualisasi data barang dan status peminjaman secara real-time.
* **📂 Manajemen Inventaris**: Pengelolaan data barang (Model `Barang`) mencakup nama, kode, dan lokasi penyimpanan.
* **🛠️ Kontrol Kondisi**: Pelacakan status barang secara mendetail (Kondisi Baik/Rusak).
* **🔄 Sistem Peminjaman**: Alur transaksi pinjam-kembali yang terintegrasi (Model `Peminjaman`).
* **👤 Profil Admin**: Halaman pengaturan profil yang disesuaikan dengan branding HIMA-TI.

---

## 📸 Tampilan Aplikasi

| **Dashboard Utama (update)** | **Tampilan Profile (update)** |
| :---: | :---: |
...
1. **Clone Repository**
   ```bash
   git clone [https://github.com/BaridNst/Tugas-Akhir-Pemograman-Web-Kelompok-4.git](https://github.com/BaridNst/Tugas-Akhir-Pemograman-Web-Kelompok-4.git)
   cd Tugas-Akhir-Pemograman-Web-Kelompok-4
